-- FUNCTION: public."3_3_fill_drug_mapper_with_pharmgkb_1"()

-- DROP FUNCTION public."3_3_fill_drug_mapper_with_pharmgkb_1"();

CREATE OR REPLACE FUNCTION public."3_3_fill_drug_mapper_with_pharmgkb_1"(
	)
    RETURNS void
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION public."3_3_fill_drug_mapper_with_pharmgkb_1"()
    OWNER TO postgres;


-- FUNCTION: public."3_3_fill_drug_mapper_with_pharmgkb_2"()

-- DROP FUNCTION public."3_3_fill_drug_mapper_with_pharmgkb_2"();

CREATE OR REPLACE FUNCTION public."3_3_fill_drug_mapper_with_pharmgkb_2"(
	)
    RETURNS void
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION public."3_3_fill_drug_mapper_with_pharmgkb_2"()
    OWNER TO postgres;



--run function1
SELECT public."3_3_fill_drug_mapper_with_pharmgkb_1"();

--run function2
SELECT public."3_3_fill_drug_mapper_with_pharmgkb_2"();
